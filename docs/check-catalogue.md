...
| C04 | `SIGNATURE_VERIFIES` | `signed_document` | `must` | no | RFC 8785 number formatting<br>RFC 7515 5.2 + A2A 8.4 (JCS payload)<br>RFC 7515 5.2: at least one JWS Signature value MUST successfully validate, or the JWS MUST be considered invalid | https://www.rfc-editor.org/rfc/rfc8785.html<br>https://www.rfc-editor.org/rfc/rfc7515.html#section-5.2 | `checks_signed.py` x8 |
